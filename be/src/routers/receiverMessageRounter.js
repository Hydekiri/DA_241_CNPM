module.exports = (router) => {
    ...
    router.post("/notifications/send", middlewareController.verifyAdmin, receiverMessageController.sendNotificationToUser);

    // Lấy danh sách người nhận của một thông báo
    router.get("/notifications/:notificationId/receivers", middlewareController.verifyAdmin, receiverMessageController.getReceiversByNotification);

    // Lấy danh sách thông báo được gửi đến một người dùng
    router.get("/users/:userId/notifications", middlewareController.verifyAdmin, receiverMessageController.getNotificationsForUser);

    // Xóa một người nhận khỏi thông báo
    router.delete("/notifications/:notificationId/receivers/:userId", middlewareController.verifyAdmin, receiverMessageController.removeReceiverFromNotification);

    // Gửi thông báo đến tất cả người dùng
    router.post("/notifications/sendToAll", middlewareController.verifyAdmin, receiverMessageController.sendNotificationToAllUsers);
};
