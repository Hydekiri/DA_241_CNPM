-- Bảng User
INSERT INTO da241_db.`User` ( `user_ID`, `email`, `password`, `name`, `role`, `pageBalance`) VALUES
( 1, 'student1@example.com', 'password123', 'Student One', 'student', 100),
( 2, 'student2@example.com', 'password456', 'Student Two', 'student', 150),
(3, 'spso1@example.com', 'password789', 'SPSO One', 'spso', 0),
(4, 'spso2@example.com', 'password321', 'SPSO Two', 'spso', 0),
(5, 'student3@example.com', 'password654', 'Student Three', 'student', 200);

-- Bảng FileType
INSERT INTO da241_db.`FileType` (`type`, `spso_ID`) VALUES
('PDF', 3),
('DOCX', 3),
('TXT', 4),
('JPEG', 4),
...
-- Bảng AutoPaper
INSERT INTO da241_db.`AutoPaper` (`semester`, `number`, `scheduler`, `spso_ID`) VALUES
...
-- Bảng Location
INSERT INTO da241_db.`Location` (`campus`, `building`, `room`) VALUES
...
-- Bảng Printer
INSERT INTO da241_db.`Printer` (`branchName`, `model`, `description`, `status`, `loc_ID`) VALUES
...
INSERT INTO da241_db.`PrintConfiguration` (`printStart`, `printEnd`, `user_ID`, `printer_ID`, `numPages`, `numCopies`, `paperSize`, `printSide`, `orientation`, `status`) VALUES
...
-- Bảng Document
INSERT INTO da241_db.`Document` (`config_ID`, `name`, `size`, `lastModifiedDate`) VALUES
...
-- Bảng Properties
INSERT INTO da241_db.`Properties` (`config_ID`, `pageSize`, `noCopy`, `noPage`, `startPage`, `endPage`, `scale`, `isDuplex`, `orientation`) VALUES
...
-- Bảng Orders
INSERT INTO da241_db.`Orders` (`user_ID`, `quantityPaper`, `quantityPackage1`, `quantityPackage2`, `quantityPackage3`, `totalCost`, `dateOrder`, `datePaid`, `status`) VALUES
...
-- Bảng Paper_Package
INSERT INTO da241_db.`Paper_Package` (`name`, `quantity`, `price`) VALUES
...
-- Bảng Order_Package
INSERT INTO da241_db.`Order_Package` (`order_ID`, `description`, `price`, `originalPrice`, `discount`) VALUES
...
INSERT INTO da241_db.`Notification_Message` (`title`, `content`) VALUES
...
INSERT INTO da241_db.`Receiver_Message` (`notification_ID`, `user_ID`, `status`) VALUES
(1, 1, 'read'),
(2, 2, 'unread'),
(3, 3, 'read'),
(4, 4, 'unread'),
